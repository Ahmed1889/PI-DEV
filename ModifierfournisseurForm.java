...
public class ModifierfournisseurForm extends BaseForm {
     ...
     public ModifierfournisseurForm(Resources res,int id,String name,String tel, String email, String site,String catf ) {

        
         initGuiBuilderComponents(res,id, name, tel,  email,  site, catf);
...
// <editor-fold defaultstate="collapsed" desc="Generated Code">                          
    private void initGuiBuilderComponents(Resources resourceObjectInstance, int id, String name,String tel, String email, String site,String catf) {
        ...
        gui_Button_2.setName("Button_2");
          ...
          gui_Button_2.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    if (ServiceFournisseur.getInstance().ModifierFournisseurJson(r)==1) {
