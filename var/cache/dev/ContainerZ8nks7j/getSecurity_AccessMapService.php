...
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/front/'), [0 => 'IS_AUTHENTICATED_ANONYMOUSLY'], NULL);
...
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/conge/'), [0 => 'ROLE_ADMIN', 1 => 'ROLE_EMPLOYE'], NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/employee/'), [0 => 'ROLE_ADMIN', 1 => 'ROLE_EMPLOYE'], NULL);
