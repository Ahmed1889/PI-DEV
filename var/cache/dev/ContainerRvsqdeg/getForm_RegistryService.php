...
}, 'Discutea\\DForumBundle\\Form\\Type\\Remover\\RemoveCategoryType' => function () {
    return ${($_ = isset($this->services['discutea.forum.form.remove.category']) ? $this->services['discutea.forum.form.remove.category'] : $this->load('getDiscutea_Forum_Form_Remove_CategoryService.php')) && false ?: '_'};
}, 'Discutea\\DForumBundle\\Form\\Type\\Remover\\RemoveForumType' => function () {
    return ${($_ = isset($this->services['discutea.forum.form.remove.forum']) ? $this->services['discutea.forum.form.remove.forum'] : $this->load('getDiscutea_Forum_Form_Remove_ForumService.php')) && false ?: '_'};
