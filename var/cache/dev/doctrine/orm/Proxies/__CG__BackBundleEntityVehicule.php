 ...
 */
class Vehicule extends \BackBundle\Entity\Vehicule implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BackBundle\\Entity\\Vehicule' . "\0" . 'id', '' . "\0" . 'BackBundle\\Entity\\Vehicule' . "\0" . 'nom', '' . "\0" . 'BackBundle\\Entity\\Vehicule' . "\0" . 'matricule', '' . "\0" . 'BackBundle\\Entity\\Vehicule' . "\0" . 'disponibilite', '' . "\0" . 'BackBundle\\Entity\\Vehicule' . "\0" . 'typeVehicule'];
        }
