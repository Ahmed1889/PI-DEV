 ...
 */
class employee extends \BackBundle\Entity\employee implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'BackBundle\\Entity\\employee' . "\0" . 'cin', '' . "\0" . 'BackBundle\\Entity\\employee' . "\0" . 'avert', '' . "\0" . 'BackBundle\\Entity\\employee' . "\0" . 'nom', '' . "\0" . 'BackBundle\\Entity\\employee' . "\0" . 'prenom', '' . "\0" . 'BackBundle\\Entity\\employee' . "\0" . 'adresse', '' . "\0" . 'BackBundle\\Entity\\employee' . "\0" . 'image', '' . "\0" . 'BackBundle\\Entity\\employee' . "\0" . 'tel', '' . "\0" . 'BackBundle\\Entity\\employee' . "\0" . 'salaire', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
    ...
    public function getAvert()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAvert', []);

        return parent::getAvert();
    }
    ...
    public function setAvert($avert)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAvert', [$avert]);

        return parent::setAvert($avert);
    }
