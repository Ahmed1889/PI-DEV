...
import com.maxi.myapp.entities.Wishlist;
...
//        gui_Container_3.addComponent(gui_Text_Area_1);
        ...
        gui_Label_3.setText(Wishlist.getInstance().wl.get(i).getLibelle_p());
...
//            gui_Label_6.setName("Label_6");
        ...
        btn.addActionListener((ActionListener)(ActionEvent e)->
        {
                   ...
                   p.setLibelle_p(gui_Label_3.getText());
                   Wishlist.getInstance().wl.remove(p);
