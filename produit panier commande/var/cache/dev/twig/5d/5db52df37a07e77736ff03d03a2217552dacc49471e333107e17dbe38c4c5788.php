...
class __TwigTemplate_97a2e03eeab14a0cfd3c1be4b5f75725ab82ea39c9cf8414c405f7a3f10fc1c4 extends \Twig\Template
{
    ...
    <table class=\"table table-striped\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["bonReduction"]) {
            ...
            // line 25
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("delete", ["id" => $this->getAttribute($context["bonReduction"], "id", [])]), "html", null, true);
            echo "\">Supprimer</a>
...
{% block bodyback %}
        ...
        {% for bonReduction in bonReductions %}
            <tr>
                ...
                <td>
                            ...
                            <a class=\"btn btn-danger\" href=\"{{ path('delete', { 'id': bonReduction.id }) }}\">Supprimer</a>
    ...
    <ul>
            ...
            <a class=\"btn btn-info\" href=\"{{ path('pdfbon') }}\">PDF BONS DE REDUCTION</a>
