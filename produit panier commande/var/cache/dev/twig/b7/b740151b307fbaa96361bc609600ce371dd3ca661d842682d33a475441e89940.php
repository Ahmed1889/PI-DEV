...
class __TwigTemplate_bb70f0f612a8cb4fcecb4054682ef71eb8b10407400e7eebc77430127b4fa554 extends \Twig\Template
{
    ...
    <ul>
        ...
        echo "\">Create a new bonReduction</a>
        </li>
    </ul>
";
    ...
    {
        return array (  119 => 37,  112 => 32,  100 => 26,  94 => 23,  87 => 19,  81 => 18,  78 => 17,  74 => 16,  60 => 4,  51 => 3,  29 => 1,);
    }
...
{% block body %}
        ...
        {% for bonReduction in bonReductions %}
            <tr>
                ...
                <td>
                    <ul>
                        <li>
                            <a href=\"{{ path('bonreduction_show', { 'id': bonReduction.id }) }}\">show</a>
                        </li>
                        <li>
                            <a href=\"{{ path('bonreduction_edit', { 'id': bonReduction.id }) }}\">edit</a>
                        </li>
                    </ul>
                </td>
            </tr>
    ...
    <ul>
        <li>
            <a href=\"{{ path('bonreduction_new') }}\">Create a new bonReduction</a>
        </li>
    </ul>
{% endblock %}
