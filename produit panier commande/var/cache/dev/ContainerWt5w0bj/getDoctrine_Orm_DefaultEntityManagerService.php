...
$c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, [0 => ($this->targetDirs[3].'/src/AppBundle/Entity'), 1 => ($this->targetDirs[3].'/src/FrontBundle/Entity'), 2 => ($this->targetDirs[3].'/src/BackBundle/Entity')]);
...
$a->setEntityNamespaces(['AppBundle' => 'AppBundle\\Entity', 'FrontBundle' => 'FrontBundle\\Entity', 'BackBundle' => 'BackBundle\\Entity']);
